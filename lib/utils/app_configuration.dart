...
Future<void> setAppConfigurations(AppConfigurationModel data) async {
  ...
  appConfigurationStore.setInquiryEmail(data.inquiryEmail.validate());
  appConfigurationStore.setHelplineNumber(data.helplineNumber.validate());
...
class AppConfigurationModel {
  ...
  int? adminAppMinimumVersion;
  int? adminAppLatestVersion;
  ...
  AppConfigurationModel.fromJsonMap(Map<String, dynamic> map)
      : siteName = map["site_name"],
        ...
        forceUpdateAdminApp = map["force_update_admin_app"],
        adminAppMinimumVersion = map["admin_app_minimum_version"],
        adminAppLatestVersion = map["admin_app_latest_version"],
  ...
  Map<String, dynamic> toJson() {
    ...
    data['force_update_admin_app'] = forceUpdateAdminApp;
    data['admin_app_minimum_version'] = adminAppMinimumVersion;
    data['admin_app_latest_version'] = adminAppLatestVersion;
